...
# Run with: curl -fsSL https://raw.githubusercontent.com/pechrista/home-tools/main/olympus/setup-housekeeping.sh | bash
...
# 3. Delete itself after setup is complete
